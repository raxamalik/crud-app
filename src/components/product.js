...
import { InlineEdit, MultilineEdit } from './main/mainfile'
const user = {
    name: 'Tom Cook',
...
const navigation = [
    { name: 'Dashboard', linkto: 'product', current: true },
    { name: 'New Arrival', linkto: 'newarrival', current: false },
...
export default function Product() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3500/homepage`, requestOptions)
                    ...
                    <main className='dark:bg-gray-700 transition duration-150 ease-in-out'>
                        ...
                        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                            ...
                            <div className="px-4 py-6 sm:px-0 ">
                                <div className="dark:bg-gray-500 rounded-lg border-4 border-dashed border-gray-200 transition duration-150 ease-in-out">
                    ...
                    <footer className='bg-gray-800 py-12'>
                        <div className="flex flex-row justify-between items-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
                            <div className='flex lg:flex-row justify-center lg:items-center items-start flex-col'>
                                ...
                                <ul className="flex lg:flex-row flex-col justify-center pl-sm-0 m-0 lg:space-x-4 lg:space-y-0 space-y-4 lg:pl-5">
