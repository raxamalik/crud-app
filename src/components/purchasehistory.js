...
const navigation = [
    ...
    { name: 'Purchase History', linkto: 'purchasehistory', current: true },
...
export default function PurchaseHistory() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3500/purchasehistory`, requestOptions)
                ...
                <div className='sticky h-[calc(100vh-64px)] overflow-y-auto'>
                    ...
                    <header className="bg-white shadow dark:bg-gray-500 transition duration-150 ease-in-out">
                        <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
                            <h1 className="text-3xl font-bold tracking-tight text-gray-900">PurchaseHistory</h1>
                        </div>
                    </header>
